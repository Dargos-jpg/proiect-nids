...
def _make_panel(tmp_path: Path, monkeypatch) -> DashboardPanel:
    ...
    # Faza 6 (DATASET-COMPARISON.md): fara asta, ModernLocalModelManager.load_or_new()
    # ar citi/scrie fisierul REAL de pe disc (poate exista deja, cu date
    # reale acumulate de user) - la fel de nedeterminist ca la sistemul vechi
    monkeypatch.setattr(
